            ...
            <div class="wrapper">
                <div class="panel">
                    ...
                    <form action="/send" method="POST">
                        ...
                        <input type="text" name="title" id="inp-title" placeholder="عنوان الرسالة" oninput="updatePreview()" value="NEXAS STORE 🚀">

                        <label>📄 Description (المحتوى):</label>
                        <textarea name="description" id="inp-desc" placeholder="اكتب تفاصيل المنتجات..." oninput="updatePreview()">اضغط على الزر بالأسفل لفتح تذكرة أو استخدم أمر /rate للتقييم 👇</textarea>

                        <div class="row">
                            <div>
                                <label>🎨 لون الـ Embed:</label>
                                <input type="color" name="color" id="inp-color" value="#5865F2" style="height: 38px; cursor: pointer;" oninput="updatePreview()">
                            </div>
                            <div>
                        ...
                        <input type="text" name="footer" id="inp-footer" placeholder="حقوق المتجر" value="NEXAS Store Team" oninput="updatePreview()">
                ...
                <div class="preview-box">
                    ...
                    <div class="discord-embed" id="preview-border">
                        <div id="prev-title" class="d-title">NEXAS STORE 🚀</div>
                        <div id="prev-desc" class="d-desc">اضغط على الزر بالأسفل لفتح تذكرة أو استخدم أمر /rate للتقييم 👇</div>
                        <div id="prev-footer"
